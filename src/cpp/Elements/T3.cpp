...
unsigned int CT3::SizeOfStiffnessMatrix()
{
    return 45;
    // 9 * 10 / 2
}
...
void CT3::ElementStiffness(double* Matrix)
{
    ...
    CT3Material& material =
        *static_cast<CT3Material*>(ElementMaterial); // Pointer to material of the element
...
void CT3::ElementStress(double stress[3], double* Displacement, double GaussPosition[9],
                              double GaussDisplacements[9], double weights[3])
{
    ...
    CT3Material& material = *static_cast<CT3Material*>(ElementMaterial);
